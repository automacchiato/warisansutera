...
class PDF extends FPDF
{
    function Header()
    {
        ...
        // $this->Cell(50, 5, "TEL: 082-239278 | H/P: 017-8203560 / 012-8079091", 0, 1, "L");
        // $this->Cell(50, 5, "Email: malmo6870k@gmail.com", 0, 1, "L");
    }
}
...
while ($row = $items->fetch_assoc()) {
    ...
    switch (strtoupper($row['item_type'])) {
        ...
        case 'TROUSER':
            ...
            //Drawing
            $pdf->Image(__DIR__ . "/../customer/uploads/drawings/" . $work['drawing'], 110, 90, 80, 80);
