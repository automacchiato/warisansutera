...
while ($row = $items->fetch_assoc()) {
    ...
    switch (strtoupper($row['item_type'])) {
        case 'SHIRT':
            ...
            $pdf->SetFont('Arial', '', 12);
            $pdf->Cell(31, 8, "Invoice No.", 1);
            $pdf->Cell(31, 8, $invoice['invoice_number'], 1);
            $pdf->Cell(31, 8, "Manufacturer", 1);
            $pdf->Cell(31, 8, $work['manufacturer'], 1);
            $pdf->Cell(31, 8, "Manufacturer", 1);
            $pdf->Cell(31, 8, $work['manufacturer'], 1, 1);
            $pdf->Ln(10);
