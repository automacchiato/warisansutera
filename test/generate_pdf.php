...
$pdf->Cell(50, 7, $invoice['total_amount'], 1, 1);

$pdf->SetX(120);
$pdf->Cell(60, 7, "Deposit", 1);
$pdf->Cell(50, 7, $invoice['deposit_amount'], 1, 1);

$pdf->SetX(120);
$pdf->Cell(60, 7, "Balance", 1);
$pdf->Cell(50, 7, $invoice['balance_amount'], 1, 1);

$pdf->SetX(120);
$pdf->Cell(60, 7, "Additional Deposit", 1);
$pdf->Cell(50, 7, $invoice['additional_deposit'], 1, 1);

$pdf->SetX(120);
$pdf->Cell(60, 7, "Final Balance", 1);
$pdf->Cell(50, 7, $invoice['additional_amount'], 1, 1);
