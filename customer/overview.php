...
$sql = "
    ...
    JOIN shirt_workslip s ON i.invoice_id = s.invoice_id

    UNION ALL

    SELECT c.customer_id, c.customer_name, c.customer_phone,
           i.invoice_id, i.invoice_number,
           'Trousers' AS apparel_type, t.item, t.quantity, t.delivery_date
    FROM invoices i
    JOIN customers c ON i.customer_id = c.customer_id
    JOIN trousers_workslip t ON i.invoice_id = t.invoice_id
    ...
    FROM invoices i
    JOIN customers c ON i.customer_id = c.customer_id
    JOIN jacket_workslip j ON i.invoice_id = j.invoice_id
    ...
    FROM invoices i
    JOIN customers c ON i.customer_id = c.customer_id
    JOIN bajumelayu_workslip b ON i.invoice_id = b.invoice_id
";
